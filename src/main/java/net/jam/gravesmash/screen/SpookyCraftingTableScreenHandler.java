...
public class SpookyCraftingTableScreenHandler extends AbstractRecipeScreenHandler<CraftingInventory> {
    ...
    public SpookyCraftingTableScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, Blocks.SPOOKY_CRAFTING_TABLE);
    }
