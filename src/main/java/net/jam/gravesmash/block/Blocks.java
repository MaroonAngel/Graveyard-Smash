...
// Pumpkins
public static final Block WHITE_PUMPKIN = new Block(FabricBlockSettings.of(Material.GOURD).strength(1.0f).sounds (BlockSoundGroup.WOOD));
public static final Block GREEN_PUMPKIN = new Block(FabricBlockSettings.of(Material.GOURD).strength(1.0f).sounds (BlockSoundGroup.WOOD));
